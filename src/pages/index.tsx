...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`ROQ Restaurant booking engine`}</title>

        <meta
          name="description"
          content="Welcome to ROQ Restaurant Booking Engine - Streamlining Table Reservations and Menu Management for a Superior Dining Experience."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`ROQ Restaurant booking engine`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to ROQ Restaurant Booking Engine - Streamlining Table Reservations and Menu Management for a Superior Dining Experience.`}
            </Text>
            <Box
